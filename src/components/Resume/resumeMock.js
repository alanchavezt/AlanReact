const resume = {
    ...
    summary: "Innovative and deadline-driven Software Engineer with 7+ years of experience designing and developing user-centered digital/print marketing material from initial concept to final, polished deliverable.",
    objective: "Diligent software engineer with 7+ years experience in software development. Eager to build innovative and cutting edge business solutions for the impressive suite of clients within its global reach. In previous roles, slashed downtime by 25% and ensured 98% on-time project completion. Also identified and dealt with a significant process bottleneck that boosted coding efficiency by 35% when resolved.",
    education: [
        {
        ...
        },
        {
            ...
            degree: "Bachelor of Science in System Engineering ",
    ...
    experience: [
        ...
        {
            employer: "Kingsley Management Corporation",
            jobTitle: "Software Engineer",
        ...
        {
            employer: "UVU Rapid Development Center",
